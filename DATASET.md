...
**S3DIS Dataset:** Download the offical data from [here](http://buildingparser.stanford.edu/dataset.html#Download) or [opendatalab](https://opendatalab.org.cn/OpenDataLab/S3DIS). Unzip and preprocess the file under data/s3dis.  The directory structure should be
